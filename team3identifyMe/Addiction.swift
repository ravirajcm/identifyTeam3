...
class Addiction: UIViewController, ALAccordionSectionDelegate , UITableViewDelegate, UITableViewDataSource {
    ...
    let headerView: UIView =
        {
            ...
            tempImage.image = #imageLiteral(resourceName: "icAsset 648")
